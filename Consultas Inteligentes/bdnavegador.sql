...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-09-2019 a las 07:47:25
...
(4, 'Prueba', '4587956', 'Boca del Monte', 'Juan Gamez', 1),
(5, 'Nueva', '255546', 'ciudad ', 'Edgar', 0);
...
--
ALTER TABLE `tbl_bodega`
  MODIFY `kbodega` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
