...
namespace pruebaDll
{
    public partial class frm_mdi : Form
    {
        ...
        {
            frmbodega nuevo = new frmbodega(sIdUsuario);
        ...
        {
            Proovedor proovedor = new Proovedor(sIdUsuario);
            proovedor.MdiParent = this;
            proovedor.Show();
        }

        private void ConsultasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Consultas consultas = new Consultas(sIdUsuario);
