...
namespace ConsultasInteligentes
{
    ...
    public partial class ComponenteConsultas : UserControl
    {
        ...
        int contadorAgregar1 = 0, ContadorLogico1 = 0, ContadorComparacion1 = 0, ContadorAgrup1 = 0;
        string Comilla = " ' ";
        ...
        private void btnCrearConsulta_Click(object sender, EventArgs e)
        {
            ...
            log.InsertarCampos(QueryComplejoTotal, txtNombreConsulta.Text, sIddUsuario);
            QuerySimpleComplete = "";
            QueryComplejoComp = "";
            QueryComplejoOrden = "";
            QueryComplejoTotal = "";
        ...
        private void BtnEditarA2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("No se puede agregar mas de 2 queys simplles");
                    }
